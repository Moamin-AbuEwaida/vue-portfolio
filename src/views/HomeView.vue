    ...
    <v-container fluid>
        ...
        <v-row>
          <v-col cols="5">
            <div style="position: relative" class="mt-16">
              ...
              <h1 class="text-white">I'm SomeOne</h1>
          ...
          <v-row>
            ...
            <v-col cols="12" sm="6">
              ...
              <p class="text-grey">
                ...
                possimus quod excepturi, magni facere alias aliquam veritatis
                vitae sit, laudantium beatae harum reprehenderit dolores nulla
                dolorem voluptate id! Aperiam, ratione?
              </p>
              <br />
              <p class="text-grey">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed,
            ...
            <v-col cols="12">
              <div class="child">
                ...
                <p class="text-grey ml-3 mt-4 text-caption">
                  ...
                  adipisicing elit. Ipsa,<br />
                  optio laborum. Maiores
                </p>
              </div>
              <div class="child">
                <v-btn
      ...
      <v-col cols="12" sm="12">
        <div class="d-flex justify-center mb-6">
          <v-btn color="#f8df2e" class="mr-2">All</v-btn>
      ...
      <v-col cols="12" sm="12">
        <div class="d-flex justify-center mb-6">
          <v-btn color="#f8df7e" class="mt-4">Load More</v-btn>
        </div>
      </v-col>
          ...
          <v-row>
            <v-col cols="12" sm="4">
              <v-card class="mx-auto" max-width="344" height="">
                ...
                <v-card-subtitle>By AAE IdeaPro | @2023</v-card-subtitle>
                <c-card-text->
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Debitis rem voluptate ex, fugit corporis qui recusandae itaque
                  voluptatem expedita natu
                </c-card-text->
              </v-card>
            </v-col>
            <v-col cols="12" sm="4">
          ...
          <v-row>
            <v-col cols="12" sm="8">
              ...
              <p class="text-grey">
                ...
                suscipit eius optio quam sint consequatur, quaerat nam ab
                explicabo .
              </p>
            </v-col>
            <v-col cols="12" sm="4">
        ...
        <v-row>
          <v-col cols="12" sm="4">
            <div class="child">
              ...
              ></v-btn
              ><br />
              <span class="text-caption">Koekelberg, Bruxelles</span><br />
              <v-btn
              ...
              ></v-btn
              ><br />
              <span class="text-caption">123-456-789</span><br />
              <span class="text-caption">123-456-789</span><br />
              <v-btn
              ...
              ></v-btn
              ><br />
              <span class="text-caption">xxx@yyy.com</span><br />
              <span class="text-caption">zzz@yyy.com</span><br />
            </div>
          </v-col>
          <v-col cols="12" sm="8">
            ...
            <span class="text-caption"
              ...
              facere cupiditate maiores enim et molestias reprehenderit sint. A,
              porro! Reprehenderit temporibus molestias neque explicabo omnis
              minima adipisci eaque iure voluptate.</span
            >
            <v-row class="mt-10">
              <v-col cols="12" sm="6">
                <v-text-field
